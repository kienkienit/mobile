...
public class DrinkManagementAdapter extends RecyclerView.Adapter<DrinkManagementAdapter.DrinkViewHolder> {

    private final List<Drink> listDrink;
    private final IClickDrinkListener iClickDrinkListener;

    public DrinkManagementAdapter(List<Drink> list, IClickDrinkListener listener) {
        this.listDrink = list;
    ...
    public void onBindViewHolder(@NonNull DrinkViewHolder holder, int position) {
        ...
        holder.layoutItem.setOnClickListener(view
                -> iClickDrinkListener.onClickDrinkItemManagement(drink));
    }
